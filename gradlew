...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    i=0
    for arg in "$@" ; do
        CHECK=`echo "$arg"|egrep -c "$GRADLE_OPTS_PATTERN" `
...
eval set -- $DEFAULT_JVM_OPTS $GRADLE_OPTS $GRADLE_USER_OPTS -classpath "\"$CLASSPATH\"" org.gradle.wrapper.GradleWrapperMain "$APP_ARGS"
