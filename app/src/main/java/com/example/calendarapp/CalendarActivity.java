...
public class CalendarActivity extends AppCompatActivity {
        ...
        eventRepository.getEventsByDateRange(monthStart, monthEnd, new EventRepository.OnEventsLoadListener() {
            ...
            public void onEventsLoaded(List<Event> events) {
                ...
                runOnUiThread(() -> {
                    ...
                    updateCalendarDayMarkers(events);
                });
            }
    ...
    private void updateCalendarDayMarkers(List<Event> events) {
        List<CalendarUtils.CalendarDay> days = calendarDayAdapter.getCalendarDays();
        for (CalendarUtils.CalendarDay day : days) {
            day.hasEvent = false;
            for (Event event : events) {
                if (DateUtils.isSameDay(day.getTimeInMillis(), event.startTime)) {
                    day.hasEvent = true;
                    break;
                }
            }
